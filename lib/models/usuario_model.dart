...
class Usuario {
  ...
  Usuario({
    ...
    required this.aprendizajeAuditivo,
    required this.aprendizajeCinestesico,
    required this.aprendizajeVisual,
    required this.claveAcceso,
    required this.claveEmpresaArea,
    required this.claveEmpresaDepartamento,
    required this.claveEmpresaPuesto,
    required this.correo,
    required this.correoPersonal,
    required this.fechaAlta,
    required this.idArea,
    required this.idClienteEmpresa,
    required this.idClienteOficina,
    required this.idClienteSucursal,
    ...
    required this.idUsuarioMetricas,
